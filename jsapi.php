...
$mchid = '1488333212';          //微信支付商户号 PartnerID 通过微信支付商户资料审核后邮件发送
$appid = 'wxa5172ba00401e26e';  //微信支付申请对应的公众号的APPID
$appKey = 'd6063e5268a0637b6db62d2a4b01b83a';   //微信支付申请对应的公众号的APP Key
$apiKey = 'FWSKEY20190726LQ9482958295829521';   //https://pay.weixin.qq.com 帐户设置-安全设置-API安全-API密钥-设置API密钥
//①、获取用户openid
...
//        $unifiedOrder->setParameter("sub_mch_id",'1489131162');//
//        $unifiedOrder->setParameter("sub_appid",'wx58fe923e49e424f4');//
